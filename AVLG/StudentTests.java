...
public class StudentTests {
    ...
    public void testAVL2Unchanged() throws InvalidBalanceException, EmptyTreeException {
        ...
        tree.insert(20);
        tree.insert(30);
        assertEquals("AVL Tree should be balanced!", true, tree.isAVLGBalanced()); 
        assertEquals("AVL Tree should be a BST!", true, tree.isBST());
        ...
        assertEquals("In an AVL-2 tree with three descending order integers inserted, " +
                "the new height was not the expected one.", 1, tree.getHeight()); // Height of 2 expected
        int test = tree.delete(20);
        assertEquals("test = 20", 20, test); 
        assertEquals("AVL Tree should be balanced!", true, tree.isAVLGBalanced()); 
        assertEquals("AVL Tree should be a BST!", true, tree.isBST());
        assertEquals("In an AVL-2 tree with three descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(30), tree.getRoot()); // Root should be unchanged
        assertEquals("Search for key in the AVLG tree!", null, tree.search(20)); 
        assertEquals("In an AVL-2 tree with three descending order integers inserted, " +
                "the new height was not the expected one.", 0, tree.getHeight()); // Height of 2 expected
        int test2 = tree.delete(30);
        assertEquals("test2 = 30", 30, test2); 
        assertEquals("AVL Tree should be balanced!", true, tree.isAVLGBalanced()); 
        assertEquals("AVL Tree should be a BST!", true, tree.isBST());
        // assertEquals("Search for key in the AVLG tree!", null, tree.search(10)); 
        assertEquals("In an AVL-2 tree with three descending order integers inserted, " +
                "the new height was not the expected one.", -1, tree.getHeight()); // Height of 2 expected
    }
    ...
    public void testAVLChanged() throws InvalidBalanceException, EmptyTreeException {
        ...
        assertEquals("AVL Tree should be balanced!", true, tree.isAVLGBalanced()); 
        assertEquals("AVL Tree should be a BST!", true, tree.isBST()); 
        assertEquals("Search for key in the AVLG tree!", Integer.valueOf(1), tree.search(1)); 
        ...
        assertEquals("AVL Tree should be balanced!", true, tree.isAVLGBalanced()); 
        assertEquals("AVL Tree should be a BST!", true, tree.isBST()); 
        assertEquals("Search for key in the AVLG tree!", null, tree.search(50)); 
        assertEquals("In an AVL-2 tree with four descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(10), tree.getRoot()); // Root should change to 10
        ...
        assertEquals("Search for key in the AVLG tree!", null, tree.search(10)); 
        assertEquals("In an AVL-2 tree with four descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(11), tree.getRoot()); 
        ...
        assertEquals("Search for key in the AVLG tree!", null, tree.search(20)); 
        assertEquals("In an AVL-2 tree with four descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(5), tree.getRoot()); 
        ...
        assertEquals("Search for key in the AVLG tree!", null, tree.search(20)); 
        assertEquals("In an AVL-2 tree with four descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(2), tree.getRoot()); 
        
        tree.delete(11);
        tree.delete(2);
        assertEquals("AVL Tree should be balanced!", true, tree.isAVLGBalanced()); 
        assertEquals("AVL Tree should be a BST!", true, tree.isBST()); 
        assertEquals("Search for key in the AVLG tree!", null, tree.search(11)); 
        assertEquals("Search for key in the AVLG tree!", null, tree.search(2)); 
        assertEquals("In an AVL-2 tree with four descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(0), tree.getRoot()); 
        
        tree.delete(0);
        assertEquals("AVL Tree should be balanced!", true, tree.isAVLGBalanced()); 
        assertEquals("AVL Tree should be a BST!", true, tree.isBST()); 
        assertEquals("Search for key in the AVLG tree!", null, tree.search(11)); 
        assertEquals("Search for key in the AVLG tree!", null, tree.search(0)); 
        assertEquals("In an AVL-2 tree with four descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(1), tree.getRoot()); 
        
        tree.delete(1);
        assertEquals("AVL Tree should be balanced!", true, tree.isAVLGBalanced()); 
        assertEquals("AVL Tree should be a BST!", true, tree.isBST()); 
        assertEquals("Search for key in the AVLG tree!", null, tree.search(11)); 
        assertEquals("Search for key in the AVLG tree!", null, tree.search(1)); 
        assertEquals("In an AVL-2 tree with four descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(3), tree.getRoot()); 
